  ...
  res.send([
    {
        ...
        "description":"The Approver receives the document from the Verifier and has the following options: Reject: Rejects the document and prevents any further action. Return: Returns the document for corrections. Approve: Approves the document for final submission.",
