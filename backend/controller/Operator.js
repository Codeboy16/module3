  ...
  res.send([
    {
      ...
      description:
        "The Operator receives a document and has the ability to either Reject: Rejects the document and the document cannot be resubmitted.Return: Returns the document to the user for corrections.Forward: Forwards the document to the Verifier for the next step.",
