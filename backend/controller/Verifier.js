  ...
  res.send([
    {
      ...
      description:
        "The Verifier receives the document from the Operator and has the following actions:Reject: Rejects the document, making it unable to be resubmitted. Return: Returns the document for corrections and resubmission by the user. Approve: Approves the document and forwards it to the Approver.",
